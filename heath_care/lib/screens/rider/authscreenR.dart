...
import 'package:heath_care/screens/rider/signinr.dart';
import 'package:heath_care/screens/rider/signupr.dart';


class AuthScreenR extends StatefulWidget {
  const AuthScreenR({super.key});

  @override
  State<AuthScreenR> createState() => _AuthScreenStateR();
}

class _AuthScreenStateR extends State<AuthScreenR> {
  bool isSignIn = true;
