...
import 'package:heath_care/screens/nurse/patientsnurse.dart';
import 'package:heath_care/screens/nurse/unavailable_nurse.dart';
      ...
      children: [
        ...
        ElevatedButton(
          ...
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => const UnavailableNurse()),
            );
          },
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const PatientsFTNurse(),
                ),
              );
            },
